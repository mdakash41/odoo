...
class WebsiteSaleInherir(WebsiteSale):
    @http.route([
        '''/shop''',
        '''/shop/page/<int:page>''',
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        res = super(WebsiteSaleInherir, self).shop(page=0, category=None,search='',ppg=False,**post)
        print("Inherited Odoo Mates... from main.py file inisde controller module.")
        return res
